...
router.post(    '/characters',      passport.authenticate('jwt', {session:false}), CharacterController.create);
router.get(     '/characters',      passport.authenticate('jwt', {session:false}), CharacterController.get);
...
// eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VyX2lkIjoiNWJjY2ZmMzU5ODNjNDAzMDExZmVkNmZiIiwiaWF0IjoxNTQwMTYxMzMzLCJleHAiOjE1NDAxNzEzMzN9.x-F_xWQ0UWqaEUEVSbrc7uTJ8dhK2ReR_8JZIKgw5Kk